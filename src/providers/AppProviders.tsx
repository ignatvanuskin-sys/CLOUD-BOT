import {createContext,useContext,useEffect,useMemo,useState,type ReactNode} from 'react';import {MotionConfig} from 'framer-motion';
import {QueryClient,QueryClientProvider,useQuery} from '@tanstack/react-query';
import {authTelegram,getMe} from '../api/queries';import {session,setAuthRefreshHandler} from '../api/client';import type {User} from '../types/api';import {initTelegram,isTelegram,onTelegramEvent,telegram} from '../services/telegram';import {useFavorites,usePreferences,type Preferences} from '../stores/preferences';
