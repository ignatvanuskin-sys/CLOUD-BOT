...
const testEnv = { ...process.env, NODE_ENV: 'development', ALLOW_DEV_LOGIN: 'true', SEED_DEV_DATA: 'true', DB_DRIVER: 'sqlite', STORAGE_DRIVER: 'local', DATABASE_PATH: './data/e2e.sqlite', STORAGE_LOCAL_ROOT: './storage/e2e' };
