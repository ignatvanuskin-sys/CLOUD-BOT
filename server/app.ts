...
export function createApp() {
  ...
  if (bot) {
    bot.command('start', (ctx) => ctx.reply('������ ������� �������� �����', { reply_markup: new InlineKeyboard().webApp('������� �������', config.WEBAPP_URL || 'https://example.com') }));
    bot.command('terms', (ctx) => ctx.reply('Terms: �������� �����, ������ ����� ������ Stars. �������� ����� ���������.'));
    bot.command('support', (ctx) => ctx.reply('���������: �������� ��������� � ������� ������.'));
    bot.command('paysupport', (ctx) => ctx.reply('������� �� �������� Stars � ��������� ����������� �����.'));
